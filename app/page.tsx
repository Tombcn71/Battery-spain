        ...
        <div className="relative z-10 text-center px-4 w-full">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl mb-6 md:mb-8 text-white/90 text-pretty">
              Experimente la máxima libertad con las baterías LiFePO₄ más
              ligeras y potentes para su barco o autocaravana.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center w-full">
              {/* We wrappen de button in een extra div die we expliciet op max-content zetten */}
              <div className="w-max mx-auto">
                <button className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-10 rounded-lg transition-colors">
                  Ver Productos
                </button>
              </div>
            </div>
